...
public class StorageDaoImpl extends BasedaoA<StorageDto> {
    ...
    public List<InrepositoryShow> selectall() {
        return sessionTemplate.selectList("org.fiveguns.mapper.StorageDtoMapper.selectgroup");
    }
    ...
    public List<InrepositoryShow> selectsearch(Inrepositorysql sql) {
        ...
        List<InrepositoryShow> list = sessionTemplate.selectList("org.fiveguns.mapper.StorageDtoMapper.selectsql", sql);
