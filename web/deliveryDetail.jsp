...
--%>
<%--<%@ page import="org.goodsManagement.util.ColumnName" %>--%>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
                        ...
                        <%--<tr style="color:#000; font-size:14px; padding:10px 0;">--%>
                            <%--<s:iterator var="column"--%>
                                        <%--value="${ColumnName.DeliveryDetail}"--%>
                                        <%--id="headname">--%>
                        ...
                        <c:forEach var="dto" items="${dtos}">
                            <tr style="color:#000; font-size:14px; padding:10px 0;">
                                ...
                                <td align="center" bgcolor="#fff8f8"><c:out value="${dto.gender}"/></td>
                                <td align="center" bgcolor="#fff8f8"><c:out value="${dto.commodityname}"/></td>
